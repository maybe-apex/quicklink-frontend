...
function Onboarding() {
    return (
        <div className={"flex flex-col lg:flex-row"}>
            <div className={`bg-[#2B6CB0] lg:w-1/2 w-full min-h-screen order-2 lg:order-1`}>
                <div
                    className={
                        "max-w-3xl  mx-auto lg:ml-auto px-4 sm:px-6 md:px-8 flex-none h-max "
                    }
                >
                    <div className={"mx-w-lg h-fit space-x-2.5 pt-8 hidden lg:flex"}>
            ...
            <div
                className={"bg-gray-800 lg:w-1/2 w-full text-center justify-right xl:pr-20 order-1 lg:order-2 pb-52 lg:pb-0"}
            >
                <div className={"mx-w-lg  flex h-fit space-x-2.5 pt-8 lg:hidden px-6"}>
                    <Image src={logo} alt="quicklink"/>
                    <p className={`${kFontSemiBold.className} text-2xl`}>
                        quicklink
                    </p>
